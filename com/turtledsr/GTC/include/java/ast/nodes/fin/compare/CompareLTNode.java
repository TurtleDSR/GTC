...
public final class CompareLTNode<T extends Boolean> extends AbstractCompareNode<T> {
  private AbstractSyntaxNode<?> param1;
  private AbstractSyntaxNode<?> param2;

  public CompareLTNode(AbstractSyntaxNode<?> operand1, AbstractSyntaxNode<?> operand2) {
    param1 = operand1;
    param2 = operand2;
  }
