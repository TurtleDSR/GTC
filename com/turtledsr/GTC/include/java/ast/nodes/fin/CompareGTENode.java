...
public final class CompareGTENode<T extends Comparable<? super T>, O extends Boolean> extends AbstractCompareNode<T, O> {
  private AbstractSyntaxNode<T, T> param1;
  private AbstractSyntaxNode<T, T> param2;

  public CompareGTENode(AbstractSyntaxNode<T, T> operand1, AbstractSyntaxNode<T, T> operand2) {
    param1 = operand1;
    param2 = operand2;
  }
